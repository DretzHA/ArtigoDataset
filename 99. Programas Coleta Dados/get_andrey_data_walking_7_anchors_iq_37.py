    ...
    async with conn_pool.acquire() as connection:                                            
        ...
        async with connection.transaction():   
            ...
            SELECT 
                ...
                MAX(CASE WHEN a.idarray_coordinate = '9055c740-ff71-11ef-b668-0242ac120009' THEN iq.i_array end) AS iq_i_4,
                MAX(CASE WHEN a.idarray_coordinate = '9055ab34-ff71-11ef-b668-0242ac120009' THEN iq.i_array end) AS iq_i_3,
                MAX(CASE WHEN a.idarray_coordinate = '9055c7cc-ff71-11ef-b668-0242ac120009' THEN iq.i_array end) AS iq_i_2,
                MAX(CASE WHEN a.idarray_coordinate = '9055c790-ff71-11ef-b668-0242ac120009' THEN iq.i_array end) AS iq_i_1,
                ...
                MAX(CASE WHEN a.idarray_coordinate = '9055c740-ff71-11ef-b668-0242ac120009' THEN iq.q_array end) AS iq_q_4,
                MAX(CASE WHEN a.idarray_coordinate = '9055ab34-ff71-11ef-b668-0242ac120009' THEN iq.q_array end) AS iq_q_3,
                MAX(CASE WHEN a.idarray_coordinate = '9055c7cc-ff71-11ef-b668-0242ac120009' THEN iq.q_array end) AS iq_q_2,
                MAX(CASE WHEN a.idarray_coordinate = '9055c790-ff71-11ef-b668-0242ac120009' THEN iq.q_array end) AS iq_q_1
            FROM 
                sigivest.beacons b
            LEFT JOIN 
